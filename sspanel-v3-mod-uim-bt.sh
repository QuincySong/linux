...
sed -i 's/system,//g' /data/server/php/71/etc/php.ini
sed -i 's/proc_open,//g' /data/server/php/71/etc/php.ini
sed -i 's/proc_get_status,//g' /data/server/php/71/etc/php.ini
sed -i 's/putenv,//g' /data/server/php/71/etc/php.ini
sed -i 's/dynamic/static/g' /data/server/php/71/etc/php-fpm.conf
sed -i 's/display_errors = On/display_errors = Off/g' /data/server/php/71/etc/php.ini
...
echo "location / {try_files \$uri \$uri/ /index.php\$is_args\$args;}"> /data/server/panel/vhost/rewrite/$website.conf
sed -i "s/\/data\/web\/${website}/\/data\/web\/$website\/public/g" /data/server/panel/vhost/nginx/$website.conf
...
sed -i "s/websiteurl/$website/g" /data/web/$website/config/.config.php
sed -i "s/sspanel-mukey/$sspanelmukey/g" /data/web/$website/config/.config.php
sed -i "s/sspanel-db-databasename/$mysqldatabase/g" /data/web/$website/config/.config.php
sed -i "s/sspanel-db-username/$mysqlusername/g" /data/web/$website/config/.config.php
sed -i "s/sspanel-db-password/$mysqlpassword/g" /data/web/$website/config/.config.php
...
echo "30 22 * * * php /data/web/$website/xcat sendDiaryMail" >> /var/spool/cron/root
echo "0 0 * * * php -n /data/web/$website/xcat dailyjob" >> /var/spool/cron/root
echo "*/1 * * * * php /data/web/$website/xcat checkjob" >> /var/spool/cron/root
echo "*/1 * * * * php /data/web/$website/xcat syncnode" >> /var/spool/cron/root
...
echo -e "${Info} 自定义配置，请打开/data/web/$website/config/.config.php进行修改"
